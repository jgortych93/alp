...
// ctx zawiera obecną liczbę użytkowników i ich wszystkich w tablicy wskaźników na user
struct user_list_ctx 
{
	size_t current_idx;
	struct user* users[MAX_USERS];
};
// znajdowanie konkretnego usera po fd
...
// w razie czego dorobic zwracanie false w przypadku niepowodzenia
